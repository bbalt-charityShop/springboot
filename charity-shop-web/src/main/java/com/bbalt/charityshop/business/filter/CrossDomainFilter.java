...
public class CrossDomainFilter implements Filter {
    ...
    public void doFilter(ServletRequest rq, ServletResponse rs,
        ...
        // 设置允许跨域访问
        LOG.info("Request url = [{}] Orign = [{}]", request.getServletPath(),request.getHeader("Origin"));
        ...
        if (allowCrossDomain) {
            ...
            if (request.getHeader("Access-Control-Request-Method") != null
                ...
                response.addHeader("Access-Control-Allow-Headers",
                        "X-Requested-With, Origin, Content-Type, Cookie, Sin-Access-Token, Sin-UserAgent-Sign, " +
                                "Sin-Client-Type, Sin-Mobile, Sin-System-Version");
            }
